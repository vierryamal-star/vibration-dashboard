...
with st.sidebar:
    ...
    st.page_link("app.py",                   label="📊 Ringkasan Status", icon="📊")
    st.page_link("pages/1_Trend.py",          label="📈 Trend Vibrasi",    icon="📈")
    st.page_link("pages/2_Alarm.py",          label="🚨 Alarm & Warning",  icon="🚨")
    st.page_link("pages/3_Histori.py",        label="🗄️ Histori Data",    icon="🗄️")
    st.page_link("pages/4_Pengaturan.py",     label="⚙️ Pengaturan",       icon="⚙️")
